export const projectPolicyFAQ = {
  scope: {
    ...
    refusalRule:
      'If a question is outside heat, weather, school safety advisories, or parent/student precautions, refuse briefly and redirect to in-scope heat-safety guidance.',
  },
  policy: {
    authority:
      'Final class suspension decisions remain with school leadership and local DepEd authority. The assistant provides heat-based guidance, not official suspension orders.',
    thresholdsC: {
      safe: '< 27',
      caution: '27-32',
