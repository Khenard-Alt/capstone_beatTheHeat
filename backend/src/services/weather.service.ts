...
class WeatherService {
	...
	private currentWeatherCache: { key: string; expiresAt: number; snapshot: WeatherSnapshot } | null = null;
	private forecastCache: { key: string; expiresAt: number; result: WeatherForecastResult } | null = null;
