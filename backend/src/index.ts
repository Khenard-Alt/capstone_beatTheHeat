...
import staffMessagesRoutes from './routes/staffMessages.routes';
import incidentsRoutes from './routes/incidents.routes';
import campusAlertRoutes from './routes/campusAlert.routes';
...
app.use('/api/campus-alert', campusAlertRoutes);
