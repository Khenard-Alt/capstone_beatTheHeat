...
exports.getHeatIndexHistory = void 0;
const supabase_1 = require("../config/supabase");
const weather_service_1 = require("../services/weather.service");
const fallbackHistory = async (period, limit) => {
...
const getHeatIndexHistory = async (req, res, next) => {
    try {
...
exports.getHeatIndexHistory = getHeatIndexHistory;
//# sourceMappingURL=heatIndexController.js.map